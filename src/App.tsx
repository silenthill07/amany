    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col antialiased">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-right">
            <div>
              <h1 className="text-sm sm:text-base font-black text-slate-800">أماني محمد</h1>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative group max-w-md w-full">
                ...
                <div className="relative bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden p-6 text-center space-y-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-white">أماني محمد</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-8 text-center lg:text-right">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                ستقوم مستشارة مبيعات شركة قناة السويس لتأمينات الحياة <strong>أماني محمد</strong> بفلترة طلبك ومراجعة عمرك للوصول للبرنامج الاسترشادي المطلوب؛ احجز استشارة هاتفية مجانية وتلقى رداً وافياً خلال أقل من 24 ساعة.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-right">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <p className="text-teal-400 font-bold text-sm mt-1">أماني محمد</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-950 via-slate-950 to-emerald-950 text-white relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
          ...
          <div className="text-xs text-slate-500 pt-3">
            المستشارة أماني محمد | شركة قناة السويس لتأمينات الحياة | جميع الحقوق محفوظة © {new Date().getFullYear()}
          </div>
      ...
      <div className="fixed bottom-6 left-6 z-[99999] group">
        ...
        >
          ...
          <span className="hidden md:inline font-black text-sm pr-1">تواصل الآن مع أماني محمد</span>
